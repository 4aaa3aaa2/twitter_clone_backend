...
class FeedController:
    ...
    def get_feed_page():
        feed_type = request.args.get('type', default='for you', type=str)
        ...
        print(f"Feed type: {feed_type}, User ID: {user_id}")

        requires_auth: bool = feed_type.lower() in  ["bookmarks", "notifications", "for you", "following"]
        if requires_auth:
            try: 
        ...
        result = feed_service.get_paginated_post_ids(cursor, limit, user_id, feed_type)
